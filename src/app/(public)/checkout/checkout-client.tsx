...
export function CheckoutClient({ profile }: { profile: Profile | null }) {
  ...
  // Prefill from the signed-in customer's profile where we can.
  ...
  async function placeOrder() {
    ...
    try {
      ...
      // Session expired / not logged in — send to login and come back.
      if (res.status === 401) {
